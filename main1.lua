  ...
  };
  {
    ...
    orientation="vertical";
    {
      ...
      };
      {
        ...
        layout_gravity="center";
        radius="30dp";
        layout_marginLeft="10dp"; -- 让两个按钮之间有间距
        {
          MaterialTextView;
          layout_marginTop="5dp";
          layout_marginLeft="10dp";
...
模型设置.onClick = function()
  CustomDialog.show(activity, function(apiKey, model, maxTokens, temperature, topP, topK, frequencyPenalty, stream)
    print("API Key:", apiKey)
    print("model:", model)
    print("max_tokens:", maxTokens)
    print("temperature:", temperature)
    print(string.format('"top_p": %.1f,', topP))
    print("top_k:", topK)
    print("frequency_penalty:", frequencyPenalty)
    print("stream:", stream)
    print(string.format('"api_key": "%s", "model": "%s", "max_tokens": %d, "temperature": %.2f, "top_p": %.1f, "top_k": %d, "frequency_penalty": %.2f',
    apiKey, selectedModel, maxTokens, temperature, topP, topK, frequencyPenalty))
  end)
end